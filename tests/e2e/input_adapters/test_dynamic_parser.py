...
def test_dynamic_regex_caching(
    mock_gemini_client, whatsapp_fixture: WhatsAppFixture, tmp_path: Path
):
    ...
    from egregora.input_adapters.whatsapp.parsing import _get_parser_pattern
    from egregora.input_adapters.whatsapp.parsing import ZipMessageSource
