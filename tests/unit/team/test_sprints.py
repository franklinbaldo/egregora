import pytest
from repo.features.sprints import SprintManager
...
class TestSprintManager:
    ...
    def test_init_creates_structure(self, mock_repo_path):
        ...
        sprints_dir = mock_repo_path / ".team/sprints"
    ...
    def test_get_current_sprint(self, mock_repo_path):
        ...
        current_file = mock_repo_path / ".team/sprints/current.txt"
    ...
    def test_get_sprint_context(self, mock_repo_path):
        ...
        sprint_2_dir = mock_repo_path / ".team/sprints/sprint-2"
