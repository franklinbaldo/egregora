...
class TestPromptGeneration(unittest.TestCase):
    ...
    def test_password_injection_and_template(self):
        ...
        # Construct a loader that points to repo root .team
        repo_root = Path.cwd() / ".team"
        ...
        template_path = repo_root / "repo/templates/base/persona.md.j2"
        ...
        with unittest.mock.patch("repo.features.sprints.sprint_manager") as mock_sm:
