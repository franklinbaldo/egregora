...
def test_combine_with_enrichment_rows_basic():
    ...
    initial_data = [
        {"id": 1, "value": "old", "ts": datetime.datetime(2023, 1, 1, 10, 0, 0, tzinfo=datetime.UTC)}
    ]
    table = ibis.memtable(initial_data, schema=schema)

    new_rows = [{"id": 2, "value": "new", "ts": datetime.datetime(2023, 1, 1, 11, 0, 0, tzinfo=datetime.UTC)}]
...
def test_combine_with_enrichment_rows_missing_columns():
    ...
    initial_data = [{"id": 1, "ts": datetime.datetime(2023, 1, 1, 10, 0, 0, tzinfo=datetime.UTC)}]
    # Create table without 'extra' column
    table = ibis.memtable(initial_data)

    new_rows = [
        {"id": 2, "extra": "filled", "ts": datetime.datetime(2023, 1, 1, 11, 0, 0, tzinfo=datetime.UTC)}
    ]
    ...
    assert result_df.iloc[0]["extra"] is None
...
def test_combine_with_enrichment_rows_utc_normalization_ts():
    ...
    initial_data = [{"id": 1, "ts": datetime.datetime(2023, 1, 1, 10, 0, 0)}]
    table = ibis.memtable(initial_data)
...
def test_combine_with_enrichment_rows_utc_normalization_timestamp():
    ...
    initial_data = [{"id": 1, "timestamp": datetime.datetime(2023, 1, 1, 10, 0, 0)}]
    table = ibis.memtable(initial_data)
...
def test_combine_with_enrichment_rows_ordering():
    ...
    initial_data = [{"id": 2, "ts": datetime.datetime(2023, 1, 1, 12, 0, 0, tzinfo=datetime.UTC)}]
    table = ibis.memtable(initial_data, schema=schema)

    # Insert earlier row
    new_rows = [{"id": 1, "ts": datetime.datetime(2023, 1, 1, 10, 0, 0, tzinfo=datetime.UTC)}]
