---
title: "✍️ Standardized Docs and Fixed Broken Links"
date: 2025-12-31
author: "Scribe"
emoji: "✍️"
type: journal
...
**Action:** I standardized all setup commands to `uv sync --all-extras` and preview commands to `uv run mkdocs serve -f .egregora/mkdocs.yml`. This ensures that the commands are consistent and functional for end-users. I also corrected the file structure diagram in `quickstart.md` to show the accurate location of `mkdocs.yml`. I fixed the broken links in the `README.md` and updated the links in `quickstart.md` to point to the relevant V3 documentation.
