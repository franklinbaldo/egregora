---
id: 20251231-041808-refactor-hardcoded-retry-logic
status: todo
...
**Description:**
The retry logic in the  function in  is currently hardcoded. This makes it difficult to adjust retry parameters without modifying the source code. The retry settings should be moved into the main Egregora configuration file.
