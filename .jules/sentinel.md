...
**Prevention:** Removed the external dependency entirely and replaced it with a transparent, local Python script (`.claude/skills/jules-scheduler/scheduler.py`) that interacts directly with the Jules API. This follows the principle of "Verify Everything" by owning the execution logic.
