...
// Model aliases to keep older configuration values working
const MODEL_ALIAS_MAP = {
  'gemini-1.5-flash': 'gemini-1.5-flash-latest',
  'gemini-flash-latest': 'gemini-1.5-flash-latest',
  'models/gemini-1.5-flash': 'models/gemini-1.5-flash-latest',
  'models/gemini-flash-latest': 'models/gemini-1.5-flash-latest',
...
if (resolvedModel !== GEMINI_MODEL) {
  console.log(`ℹ️ Normalized GEMINI_MODEL '${GEMINI_MODEL}' to '${resolvedModel}' for API compatibility.`);
}
