    ...
    if mkdocs_created:
        console.print(
            Panel(
                ...
                f"2. Preview the site:\n   [cyan]cd {output_dir}[/cyan]\n   [cyan]uv tool run --with \"git+https://github.com/franklinbaldo/egregora\\[mkdocs]\" mkdocs serve -f .egregora/mkdocs.yml[/cyan]",
    ...
    *,
    ...
    console.print(
        Panel(
            ...
            "[cyan]cd demo && uv tool run --with \"git+https://github.com/franklinbaldo/egregora\\[mkdocs]\" mkdocs serve -f .egregora/mkdocs.yml[/cyan]",
            title="🚀 Demo Complete",
            border_style="green",
        )
    )
