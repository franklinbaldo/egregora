    ...
    *,
    ...
    console.print(
        Panel(
            ...
            '[cyan]cd demo && uv tool run --with "mkdocs-material[imaging]" --with pillow --with cairosvg --with mkdocs-blogging-plugin --with mkdocs-macros-plugin --with mkdocs-rss-plugin --with mkdocs-glightbox --with mkdocs-git-revision-date-localized-plugin --with mkdocs-minify-plugin mkdocs serve -f .egregora/mkdocs.yml[/cyan]',
            title="🚀 Demo Complete",
            border_style="green",
        )
    )
