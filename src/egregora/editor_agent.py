                ...
                for part in response.candidates[0].content.parts:
                    if hasattr(part, "function_call") and part.function_call:
                        ...
                        if fc_name == "query_rag":
                            ...
                            result_dict: dict[str, Any] = await _ask_llm_tool(
                            ...
                            result_dict: dict[str, Any] = editor.edit_line(
                            ...
                            result_dict: dict[str, Any] = editor.full_rewrite(
                                expect_version=fc_args.get("expect_version", 0),
                                content=fc_args.get("content", ""),
                            )

                        elif fc_name == "finish":
                            result_dict: dict[str, Any] = editor.finish(
                                expect_version=fc_args.get("expect_version", 0),
