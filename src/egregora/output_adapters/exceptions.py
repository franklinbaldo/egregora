...
class MissingMetadataError(OutputAdapterError):
...
class UniqueFilenameError(OutputAdapterError):
...
class FrontmatterDateFormattingError(OutputAdapterError):
...
class DirectoryCreationError(OutputAdapterError):
...
class FileWriteError(OutputAdapterError):
...
class DateExtractionError(OutputAdapterError):
