...
def _writer_tools() -> Sequence[genai_types.Tool]:
    ...
    metadata_schema = genai_types.Schema(
        ...
        properties={
            "title": genai_types.Schema(type=genai_types.Type.STRING, description="Engaging post title"),
            ...
            "summary": genai_types.Schema(
                type=genai_types.Type.STRING, description="Short summary (1-2 sentences)"
            ),
            ...
            "category": genai_types.Schema(
                type=genai_types.Type.STRING, description="Optional category slug", nullable=True
            ),
        },
        ...
        parameters=genai_types.Schema(
            ...
            properties={
                "content": genai_types.Schema(
                    type=genai_types.Type.STRING, description="Markdown post content"
                ),
        ...
        parameters=genai_types.Schema(
            ...
            properties={
                "author_uuid": genai_types.Schema(
                    type=genai_types.Type.STRING, description="The anonymized author UUID"
                )
            },
    ...
    write_profile_decl = genai_types.FunctionDeclaration(
        ...
        parameters=genai_types.Schema(
            ...
            properties={
                ...
                "content": genai_types.Schema(
                    type=genai_types.Type.STRING, description="Profile content in markdown format"
                ),
            },
    ...
    search_media_decl = genai_types.FunctionDeclaration(
        name="search_media",
        description="Search for relevant media (images, memes, videos, audio) by description or topic. Returns media that was previously shared in the group conversations. Use this to find visual content to illustrate your blog posts.",
        parameters=genai_types.Schema(
            type=genai_types.Type.OBJECT,
            properties={
                "query": genai_types.Schema(
                    type=genai_types.Type.STRING,
                    description="Natural language search query describing the media you're looking for. Examples: 'funny meme about procrastination', 'chart about productivity', 'image related to AI safety'",
                ),
                "media_types": genai_types.Schema(
                    type=genai_types.Type.ARRAY,
                    description="Optional filter by media type. Valid types: 'image', 'video', 'audio', 'document'. If not specified, searches all media types.",
                    items=genai_types.Schema(type=genai_types.Type.STRING),
                    nullable=True,
                ),
    ...
    annotate_conversation_decl = genai_types.FunctionDeclaration(
        ...
        description="Store a private annotation linked to a conversation message or another annotation, so it can be surfaced automatically during future writing sessions.",
        parameters=genai_types.Schema(
            type=genai_types.Type.OBJECT,
            properties={
    ...
    generate_banner_decl = genai_types.FunctionDeclaration(
        ...
        description="Generate a cover/banner image for a blog post using AI. Creates a striking, concept-driven visual that captures the essence of the article. Use this AFTER writing a post to create its banner image.",
        parameters=genai_types.Schema(
            type=genai_types.Type.OBJECT,
            properties={
                "post_slug": genai_types.Schema(
                    type=genai_types.Type.STRING, description="The slug of the post to generate a banner for"
                ),
                "title": genai_types.Schema(
                    type=genai_types.Type.STRING, description="The post title to base the banner design on"
                ),
                "summary": genai_types.Schema(
                    type=genai_types.Type.STRING,
