...
def load_agent(agent_name: str, egregora_path: Path) -> tuple[AgentConfig, str]:
    ...
    Args:
        agent_name: The name of the agent to load (e.g., "curator").
        egregora_path: The path to the .egregora directory.

    Returns:
        A tuple containing the AgentConfig and the prompt template.
    """
