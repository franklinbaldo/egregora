"""High-level RAG operations: indexing and retrieval.

This module provides functions for indexing documents into the vector store
and retrieving relevant documents using semantic search.

Merged from retriever.py and indexing.py to reduce file fragmentation.
"""
