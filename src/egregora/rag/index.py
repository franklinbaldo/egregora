...
class PostRAG:
    ...
    def _collect_post_paths(self) -> list[Path]:
        """Return markdown posts stored within recognised directory layouts."""

        patterns = [
            "*/posts/daily/*.md",  # Legacy structure
            "*/daily/*.md",  # Simplified structure generated by firebase branch
        ]
        ...
        return sorted(collected, key=lambda path: path.stem)
